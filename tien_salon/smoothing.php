...
<body>
    ...
    <section class="deskripsi mt-5">
        <div class="deskripsi-text">
            <h1>Smoothing</h1>
            <p>Di TIEN SALON, kami menawarkan layanan smoothing yang bertujuan untuk membuat rambut Anda lebih halus, 
            lembut, dan mudah diatur. Smoothing adalah solusi bagi mereka yang memiliki rambut kering, kasar, atau 
            bermasalah dengan kriput. Dengan menggunakan teknik dan produk khusus, tim ahli kami akan mengaplikasikan 
            formula smoothing yang meresap ke dalam serat rambut untuk menghilangkan kriput dan memberikan kilau yang sehat. 
            Hasilnya adalah rambut yang lebih teratur, mudah diatur, dan tampak lebih sehat. Percayakan rambut Anda kepada 
            kami di TIEN SALON, dan nikmati transformasi yang halus dan indah setelah pengalaman smoothing kami.
        </div>
        <a class="pic-haircut"><img src="image/smoothing.png" class="img-haircut"></a>
    </section>
