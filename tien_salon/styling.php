...
<body>
    ...
    <section class="deskripsi mt-5">
        <div class="deskripsi-text">
            <h1>Styling</h1>
            <p>Di TIEN SALON, kami menghadirkan layanan styling yang dirancang untuk memberikan sentuhan akhir 
            yang sempurna pada penampilan rambut Anda. Styling adalah saat yang penting untuk menyelesaikan 
            penampilan Anda dengan gaya yang sesuai dengan kepribadian dan kebutuhan Anda. Dengan menggunakan 
            berbagai teknik pemotongan dan produk styling terbaik, tim profesional kami akan membantu Anda
            menciptakan tampilan yang sesuai dengan gaya Anda, baik itu gaya rambut sehari-hari atau tampilan 
            khusus untuk acara istimewa. Percayakan penampilan rambut Anda kepada kami di TIEN SALON, dan nikmati 
            hasil styling yang mencerminkan keindahan dan kepercayaan diri Anda.
        </div>
        <a class="pic-haircut"><img src="image/styling.png" class="img-haircut"></a>
    </section>
